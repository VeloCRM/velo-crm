...
export const Icons = {
  ...
  file: (s=16) => I(s, <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></>),
  undo: (s=16) => I(s, <><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"/></>),
...
export function FormField({ label, children, dir }) {
  return (
    <div style={{ marginBottom: 16 }}>
      <label style={{ display: 'block', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'rgb(var(--velo-text-tertiary))', marginBottom: 8, direction: dir }}>{label}</label>
      {children}
    </div>
  )
}
...
export const inputStyle = (dir) => ({
  width: '100%', padding: '0 12px', height: 42, borderRadius: 10, border: '1px solid rgb(var(--velo-border-default))',
  fontSize: 14, color: 'rgb(var(--velo-text-primary))', fontFamily: 'inherit', outline: 'none', background: 'rgb(var(--velo-surface-raised))',
