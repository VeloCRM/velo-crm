...
const illustrations = {
  ...
  deals: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
      ...
      <rect x="24" y="50" width="18" height="36" rx="3" fill="rgba(0,255,136,0.06)" stroke="#16A34A" strokeWidth="2"/>
      <rect x="51" y="38" width="18" height="48" rx="3" fill="rgba(0,255,136,0.06)" stroke="#16A34A" strokeWidth="2"/>
      <rect x="78" y="26" width="18" height="60" rx="3" fill="rgba(0,255,136,0.06)" stroke="#16A34A" strokeWidth="2"/>
  ...
  tickets: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
      <circle cx="60" cy="60" r="56" fill="rgba(124,58,237,0.06)" opacity=".5"/>
      <rect x="30" y="30" width="60" height="60" rx="8" stroke="#7C3AED" strokeWidth="2.5" fill="rgba(124,58,237,0.06)"/>
  ...
  automations: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
      <circle cx="60" cy="60" r="56" fill="rgba(245,158,11,0.06)" opacity=".5"/>
  ...
  general: (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
      <circle cx="60" cy="60" r="56" fill="rgba(255,255,255,0.04)" opacity=".7"/>
      <rect x="36" y="32" width="48" height="56" rx="6" stroke="#6B7280" strokeWidth="2" fill="rgba(255,255,255,0.04)"/>
