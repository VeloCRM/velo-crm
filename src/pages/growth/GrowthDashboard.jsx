    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center', padding: '48px 16px' }}>
        <div style={{ ...card, maxWidth: 480, width: '100%', padding: 32, textAlign: 'center' }}>
          ...
          <div style={{ padding: '12px 16px', borderRadius: 8, background: C.primaryBg, fontSize: 12, color: C.primary, lineHeight: 1.5 }}>
      ...
      <div style={{ flex: 1, minHeight: 0, overflowY: 'auto', background: C.bg, padding: '16px 20px', display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `1px solid ${C.border}`, borderRight: `1px solid ${C.border}` }}>
        ...
        {messages.length === 0 && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, textAlign: 'center', padding: '24px 0' }}>
            <div style={{ width: 56, height: 56, borderRadius: 16, background: `linear-gradient(135deg, ${C.primaryBg}, ${C.purpleBg})`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
        ...
        {loading && (
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 4, padding: '10px 14px', background: C.white, border: `1px solid ${C.border}`, borderRadius: 12 }}>
              {[0, 1, 2].map(i => (
