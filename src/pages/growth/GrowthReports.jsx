export default function GrowthReports({ orgId }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '48px 16px' }}>
      {/* Icon */}
      <div style={{ width: 56, height: 56, borderRadius: 14, background: 'rgba(0,255,178,0.08)', border: '1px solid rgba(0,255,178,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#00FFB2" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center', width: '100%', maxWidth: 560 }}>
        {reports.map((r, i) => (
          <div key={i} style={{
            ...
            background: '#101422', border: '1px solid rgba(0,255,178,0.15)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              ...
              <span style={{
                ...
                background: 'rgba(0,255,178,0.08)', color: '#00FFB2',
